...
**Bio:** Fractional CTO w Proxi Cloud. Programistka z 15-letnim doświadczeniem (Ruby on Rails, optymalizacja baz danych). Buduję i automatyzuję produkty AI end-to-end. Prywatnie rozwijam własne projekty generative AI.

**Requirements:** Zainstalowany opencode, ulubione środowisko programistyczne, dostęp do internetu
