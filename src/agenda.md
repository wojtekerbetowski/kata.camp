...
**Bio:** Engineering Leader and hands-on AI product builder with experience in US and UK-based tech startups.

**Requirements:** n8n.io account (at least trial), API key to any LLM (preferably OpenAI)
...
**Bio:** Ivan is an engineer with more than 11 years of experience building enterprise software and ML powered applications. He has led teams and delivered practical ML features for both enterprise products and unicorn startups. His work focuses on modern UI applications, API services, and integrating AI tools into engineering workflows.

**Requirements:** Cursor IDE with at least trial version
...
**Bio:** Independent AI consultant and early adopter. He's built various AI projects - from enterprise automation to developer training. Works with several companies on AI strategy and development, specializing in practical workflows that actually ship. Likes to talk to Claude! Based in Warsaw.

**Requirements:** Claude Pro subscription
...
**Bio:** AI consultant, CTO, software dev.

**Requirements:** Cursor IDE with at least trial version, .NET 10 SDK
...
**Bio:** Maks is a founder (post-exit) and software engineer with 20+ years of experience. He built products for startups and enterprises. As a Principal Engineer at Nursa, he leads AI adoption in product development across the entire engineering and product team.

**Requirements:** Claude Code Pro subscription, free Lovable.dev account
...
**Bio:** Scott is a Senior Software Engineer with 20 years of experience, currently at Proofs where he rebuilt their entire product in 30 days using Claude Code (which wrote 90%+ of the code) and achieved their first paying customer within 14 hours of launch. He created Shotgun CLI, an open-source tool for spec-driven development that helps developers write better instructions for AI coding agents.

**Requirements:** An AI Coding Agent (Codex, Claude Code, Windsurf). Optional: Shotgun CLI installed (https://app.shotgun.sh/) with API key (OpenAI, Anthropic, or Gemini)
...
**Bio:** AI solution architect

**Requirements:** API keys to any LLM, IDE (I'll use Cursor)

---

### <span id="free-coding-agent">Not Only Claude and Codex – How to Use a Coding Agent Under the Console for Free</span>

**Speaker:** Justyna Wojtczak

**Description:** A practical workshop showing how to run a free agent for generating and refactoring code without the need to use paid models.

**Bio:** Fractional CTO at Proxi Cloud. Programmer with 15 years of experience (Ruby on Rails, database optimization). I build and automate end-to-end AI products. Privately, I develop my own generative AI projects.

**Requirements:** Installed opencode, favorite development environment, internet access
...
| 12:30  | [Rapid AI product delivery - from prototype to production](#rapid-ai-delivery)<br>Maksymilian Majer | [Not Only Claude and Codex – How to Use a Coding Agent Under the Console for Free](#free-coding-agent)<br>Justyna Wojtczak | [Code with Claude: Practical AI Development Workshop](#code-with-claude)<br>Tomasz Gancarczyk |
| 14:00  | [Rapid AI product delivery - from prototype to production](#rapid-ai-delivery)<br>Maksymilian Majer | [Not Only Claude and Codex – How to Use a Coding Agent Under the Console for Free](#free-coding-agent)<br>Justyna Wojtczak | [Code Refactoring in Cursor](#code-refactoring)<br>Matt Kutyba |
...
| 16:00  | [Workflow automation with LLMs and n8n](#workflow-automation)<br>Paweł Andziak | [Implementing features with Cursor IDE](#cursor-features)<br>Ivan Lapa | [Code Refactoring in Cursor](#code-refactoring)<br>Matt Kutyba |
