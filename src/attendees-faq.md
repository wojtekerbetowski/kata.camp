...
description: "Everything you need to know to get ready for Kata Camp—logistics, preparation, schedule, safety, and contacts."
---
...
See the full [agenda](/agenda) for session descriptions, bios, and requirements.

## What should I bring?
- **Laptop + charger** (you’ll be hands‑on all day)
- **Internet access** (venue Wi‑Fi provided; a mobile hotspot as backup is helpful)
- Any required **accounts, subscriptions, SDKs, and API keys** for the sessions you plan to attend (see per‑session “Requirements” on the [agenda](/agenda))
...
- View the live schedule on the [agenda](/agenda)
...
- Map pin: [Google for Startups Campus, Warsaw](https://maps.google.com/?q=Google%20for%20Startups%20Campus%20Warsaw)
